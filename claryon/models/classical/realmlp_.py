"""RealMLP model builder — stub.

Requires pytabkit: ``pip install pytabkit``
"""
...
@register("model", "realmlp")
class RealMLPModel(ModelBuilder):
    """RealMLP stub — not yet implemented."""
    ...
    def fit(self, X: np.ndarray, y: np.ndarray, task_type: TaskType, **kwargs: Any) -> None:
        raise NotImplementedError("RealMLP requires pytabkit: pip install pytabkit")
