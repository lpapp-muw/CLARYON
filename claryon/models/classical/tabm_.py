"""TabM model builder — stub.

Requires custom integration from yandex-research/tabm.
"""
...
@register("model", "tabm")
class TabMModel(ModelBuilder):
    """TabM stub — not yet implemented."""
    ...
    def fit(self, X: np.ndarray, y: np.ndarray, task_type: TaskType, **kwargs: Any) -> None:
        raise NotImplementedError("TabM requires custom integration from yandex-research/tabm")
