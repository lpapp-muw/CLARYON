...
CLARYON has 14 registered models (plus an ensemble aggregator) in v0.13.0.
...
Quantum neural network (QNN) and quantum convolutional network (qCNN) models are in development and will land in a future release.
...
Note: GDQ evaluates fidelity (amplitude-encoded) kernels only. It does not apply to projected quantum kernels.
...
Available models: `xgboost`, `lightgbm`, `catboost`, `mlp`, `tabpfn`, `cnn_2d`, `cnn_3d`, `angle_pqk_svm`, `projected_kernel_svm`, `kernel_svm`, `qdc_hadamard`, `quantum_gp`, `tabm`, `realmlp`, `modernnca`.
...
│   ├── quantum/              # Angle PQK SVM, Kernel SVM, QDC, GP
...
- Papp L, Visvikis D, Sollini M, Shi K, Kirienko M. "The dawn of quantum AI in nuclear medicine: an EANM perspective." *The EANM Journal* 3, 100227 (2026). https://doi.org/10.1016/j.eanmj.2026.100227. CLARYON is the official code repository for this manuscript (via [EANM-AI-QC](https://github.com/lpapp-muw/EANM-AI-QC)).
...
@article{papp2026dawn,
  ...
  year         = {2026},
  issn         = {3051-2921},
  doi          = {10.1016/j.eanmj.2026.100227}
}
